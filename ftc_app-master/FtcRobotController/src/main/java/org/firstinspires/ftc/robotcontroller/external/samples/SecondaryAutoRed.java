...
// */
//
//@Autonomous(name = "AutoSecondRed", group = "Test") // change name
//public class SecondaryAutoRed extends LinearOpMode { // change file name
...
//        sleep(4000);
//            lol.turnPIDSuperSlow(.6, 65, Direction.RIGHT, 2.0, 1000);
//            lol.drivePID(.3, 50, Direction.FORWARD, 100, 0);
//            sleep(3000);
//            lol.drivePID(.5, 25, Direction.BACKWARD, 100 , 0);
//            lol.turnPIDNotAbsolute(.6, 55, Direction.LEFT, 3.0, 1000);
//            sleep(5000);
